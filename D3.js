...
console.log(
  starWarsCharacters[r].name +
    " è alto " +
    starWarsCharacters[r].height +
    ", pesa " +
    starWarsCharacters[r].mass +
    ", ha i capelli " +
    starWarsCharacters[r].hair_color +
    ", la pelle " +
    starWarsCharacters[r].skin_color +
    ", gli occhi " +
    starWarsCharacters[r].eye_color +
    ", è nato nell'anno " +
    starWarsCharacters[r].birth_year +
    " ed è " +
    starWarsCharacters[r].gender
);
